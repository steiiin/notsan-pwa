...
<template>
  ...
  <nos-list>
    <nos-li>Postpartale Blutungen</nos-li>
  </nos-list>
  ...
  <nos-paragraphs :decent="true">
    <template v-slot:text>
      <p>
        Oxytocin wirkt, indem es die Kontraktion der glatten Muskulatur des Uterus stimuliert. 
      </p>
      <p>
        Diese Eigenschaft macht es besonders wirksam bei der Behandlung von postpartalen Blutungen, die oft durch unzureichende Kontraktionen des Uterus nach der Geburt verursacht werden.
      </p>
    </template>
  </nos-paragraphs>
  ...
  <nos-table>
    <nos-row-caption>
      ...
      <template v-slot:content>
        <nos-med-label type="iv">1 Ampulle Oxytocin</nos-med-label>
        <nos-med-dose :decent="true" :items="[{ unit: '5 I.E.', per: '1ml' }]"></nos-med-dose>
      </template>
    </nos-row-caption>
    <nos-row-caption>
      ...
      <template v-slot:content>
        <p>
          ...
          <nos-med-dose :items="[
            { unit: '5 I.E. (1 Ampulle)', color: 'adult' },
          ]"></nos-med-dose>
        </p>
      </template>
    </nos-row-caption>
...
export default {
  ...
  computed: {
    meta() {
      return this.$store.getters.getContentMeta("na-med-oxytocin");
    },
  },
  methods: {},
};
