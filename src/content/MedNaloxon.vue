    ...
    <nos-row-caption>
      ...
      <template v-slot:content>
        <p>
          ...
          <div>
            Ampulle auf <span class="nos-mono">10ml</span> NaCl aufziehen.<br />
            <span class="nos-mono">&equals;0,04mg / ml</span>
          </div>
        </p>
        <p>
...
export default {
  ...
  computed: {
    meta() {
      return this.$store.getters.getContentMeta("med-naloxon");
    },
  },
  methods: {},
};
