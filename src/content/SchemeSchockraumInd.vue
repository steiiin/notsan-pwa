...
<template>
  ...
  <nos-header title="Traumatisch" />
  <nos-header
    title="Empfehlungsgrad A (soll)"
    :decent="true"
  />
  <nos-list>
    ...
    <nos-li :decent="true">
      Penetrierende Verletzung Thorax
    </nos-li>
    <nos-li :decent="true">
      Amputation proximal Hand/Fuß
    </nos-li>
    <nos-li :decent="true">
    ...
    <nos-li :decent="true">
      Thoraxdrainage / Entlastung
    </nos-li>
    <nos-li :decent="true">
      Kreislaufunterstützung m. Katecholaminen
    </nos-li>
    <nos-li :decent="true">
  ...
  <nos-header
    title="Empfehlungsgrad B (sollte)"
    :decent="true"
  />
  <nos-list>
    ...
    <nos-li :decent="true">
      Herausscheudern einer Person aus dem PKW
    </nos-li>
    <nos-li :decent="true">
      Fraktur langer Röhrenknochen
    </nos-li>
    <nos-li>Inhalationstrauma (chemisch, thermisch, toxisch)</nos-li>
  </nos-list>

  <nos-header title="Nicht-Traumatisch" />
  <nos-list>
    <nos-li>Drohende Atemwegsverlegung (A-Problem)</nos-li>
    <nos-li>Respiratorische Insuffizienz (B-Problem)</nos-li>
    <nos-li :decent="true">
      Dyspnoe mit muskulärer Erschöpfung
    </nos-li>
    <nos-li :decent="true">
      Beatmung (invasiv &amp; niv)
    </nos-li>
    <nos-li :decent="true">
      High-Flow-Sauerstofftherapie
    </nos-li>
    <nos-li :decent="true">
      Oxygenierungsstörung (&lt;89% mit O<sub>2</sub>)
    </nos-li>

    <nos-li>Hämodynamische Instabilität (C-Problem)</nos-li>
    <nos-li :decent="true">
      RR<sub>syst.</sub> &lt; 80mmHg
    </nos-li>
    <nos-li :decent="true">
      Bradykardie (&lt; 40min<sup>-1</sup>)
    </nos-li>
    <nos-li :decent="true">
      Tachykardie (&gt; 180min<sup>-1</sup>)
    </nos-li>
    <nos-li :decent="true">
      Reanimation (Laufend/Erfolgt)
    </nos-li>
    ...
    <nos-li :decent="true">
      Hypo- / Hyperthermie (&le;32°C/&ge;40°C)
    </nos-li>
    <nos-li :decent="true">
      Sepsis (qSOFA &gt; 2)
    </nos-li>
